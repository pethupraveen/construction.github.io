                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="service-tab.php">Preconstruction Services</a></li>
                                    <li><a href="service-tab.php">Construction Services</a></li>
                                    <li><a href="service-tab.php">Building Maintenance</a></li>
                                    <li><a href="service-tab.php">Floor Rework Services</a></li>
                                    <li><a href="service-tab.php">Interior Design</a></li>
                                    <li><a href="service-tab.php">OutSide Glass Flooring</a></li>
                                    <li><a href="service-tab.php">Road Services</a></li>
                                    <li><a href="service-tab.php">PipeLine Construction</a></li>
                                    <li><a href="service-tab.php">Painting Works</a></li>
                                </ul>
                            </li>
